      ...
      <div className='grid lg:grid-cols-3 gap-5'>
        <div className='lg:col-span-2 '>
          ...
          <div className="flex w-full justify-between mt-4">
            <button className='bg-cyan-500 text-sm sm:text-base sm:px-8 sm:py-3 px-3.5 py-1.5 text-white rounded-full disabled:opacity-35 disabled:cursor-not-allowed'
              onClick={handleClick}
              disabled={Index == 0}>
